...
New-AzADDomainService -Name <String> -ResourceGroupName <String> -DomainName <String>
 ...
 [-NotificationSettingNotifyGlobalAdmin <NotifyGlobalAdmins>] [-ResourceForest <String>]
 [-ResourceForestSetting <IForestTrust[]>] [-Sku <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
